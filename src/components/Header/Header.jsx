    ...
    <>
      <div className="w-full h-[100vh] relative">
        ...
        >
          ...
          >
            <video autoPlay loop muted src="https://xgjzloifyvgpbmyonaya.supabase.co/storage/v1/object/public/files/bBj1XfrSyi/1ENIoa5sjq" className="w-full h-full object-cover"></video>
          </div>
